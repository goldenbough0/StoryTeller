...
//    });
    ...
    framelessWidgetDeveloper *developer=new framelessWidgetDeveloper;
    connect(ui->developer_btn,&QPushButton::clicked,developer,[=]()
    {
        developer->setWindowFlag(Qt::FramelessWindowHint);
        developer->setAttribute(Qt::WA_TranslucentBackground);
        developer->show();
        //this->hide();
    });
